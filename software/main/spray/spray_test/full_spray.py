...
########################################################
def spray_main_function(dict, scales_type, spray_get, animal_id, position):
    try:
        ...
        if position is False:
            ...
            if not request_get_json:
                ...
                dict['task_id'], dict['spraying_type'], dict['volume'], dict['server_time'] = __spray_json_get(request_get_json)
